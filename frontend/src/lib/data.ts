...
// leadSourceType uses the backend LeadSourceType enum values: "Opc" | "Ad" only
// commercialAgentId matches the agent IDs in FormContainer/FormPageRenderer relatedData
export const intakesData = [
  {
    ...
    genderId: "gender-1",
    leadSourceId: "ls-4",
    commercialAgent: "Sara Opc",
    commercialAgentId: "agent-1",
    ...
    notes: "Very motivated student, interested in advanced English.",
    isIndependent: false,
    leadSourceType: "Ad",
    totalFees: 12000,
    amountPaid: 12000,
  },
  {
    ...
    genderId: "gender-2",
    leadSourceId: "ls-1",
    commercialAgent: "Karim Ref",
    commercialAgentId: "agent-2",
    intakeDate: "2026-02-20",
    leadSource: "Website (OPC)",
    opc: "OPC Platform",
    subject: "Math",
    subjectId: "sub-2",
    branchId: "branch-1",
    ...
    notes: "Referred through OPC channel. Needs follow-up next week.",
    isIndependent: false,
    leadSourceType: "Opc",
    totalFees: 9600,
    amountPaid: 4800,
  ...
  },
  {
    ...
    status: "New",
    followUpDate: "",
    notes: "Walk-in inquiry via OPC. Very interested in conversation classes.",
    isIndependent: false,
    leadSourceType: "Opc",
    totalFees: 7200,
    amountPaid: 3600,
  },
  {
    ...
    followUpDate: "",
    notes: "Changed mind, will not enroll this semester.",
    isIndependent: true,
    leadSourceType: "",
    totalFees: 6000,
    amountPaid: 0,
  },
  {
    ...
    phone: "+213 770 678 901",
    dateOfBirth: "2000-04-12",
    gender: "Female",
    genderId: "gender-2",
    leadSourceId: "ls-1",
    commercialAgent: "Youcef Opc",
    commercialAgentId: "agent-3",
    intakeDate: "2026-06-01",
    leadSource: "OPC Referral",
    opc: "OPC Platform",
    subject: "Math",
    subjectId: "sub-2",
    branchId: "branch-1",
    ...
    notes: "High potential student, referred by OPC agent.",
    isIndependent: false,
    leadSourceType: "Opc",
    totalFees: 9600,
    amountPaid: 9600,
